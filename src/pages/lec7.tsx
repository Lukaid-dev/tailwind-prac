...
export default function Lec7() {
  return (
    <main className="bg-gray-100 md:bg-green-100 h-screen flex items-center justify-center p-5">
      <div className="flex flex-col md:flex-row gap-2 bg-white shadow-lg p-5 rounded-3xl w-full max-w-screen-sm *:outline-none has-[:invalid]:ring-red-200 has-[:invalid]:ring has-[:focus:invalid]:bg-red-100 ring ring-transparent transition-shadow">
        <input
